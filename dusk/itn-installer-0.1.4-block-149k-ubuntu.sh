...
LAST_STATE_URL="https://nodes.dusk.network/state/149000"
...
curl -so  /opt/dusk/installer/149000.tar.gz -L "$LAST_STATE_URL"
tar -xvf /opt/dusk/installer/149000.tar.gz -C /opt/dusk/rusk/
chown -R dusk:dusk /opt/dusk/
